...
public class Meal extends PreparedItem {
    ...
    public Meal(String name, int iconPath, int calories, MealIngredient[] ingredients, String[] instructions, ListItem.FragmentType type, ListItem.Unit baseUnit, int quantity, int dbkey) {
