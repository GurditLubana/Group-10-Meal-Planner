...
public class Drink extends PreparedItem {
    ...
    public Drink(String name, int iconPath, String[] instructions, DrinkIngredient[] ingredients, ListItem.FragmentType type, Edible.Unit baseUnit, int quantity, int dbkey) {
